...
@section('content')
    ...
    <section class="bg-white min-h-screen py-12">
        <div class="max-w-5xl mx-auto px-6 grid grid-cols-1 lg:grid-cols-2 gap-8 items-center">

            <div class="text-center lg:block hidden">
                <img src="{{ asset('default/web_1.jpg') }}" alt="Contact" class="rounded-xl shadow-md mx-auto w-full">
            </div>

            <div>
                <h1 class="text-4xl font-bold text-primaryB mb-2 text-center">Contactez-nous</h1>
                <p class="text-gray-700 mb-6 text-center">Une question ? Un souci avec votre abonnement ? N'hésitez pas à
                    nous écrire via
                    ce formulaire.</p>
                ...
                <form class="bg-gray-100 p-6 rounded-xl shadow-md space-y-5" id="contactForm" method="POST">
                    ...
                    <button type="submit"
                        class="bg-primaryB text-white px-6 py-2 rounded-lg hover:bg-primaryB/90 transition">Envoyer</button>
